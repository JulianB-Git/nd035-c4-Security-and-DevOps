...
public interface LoggerMessage {
    ...
    String LOGIN_SUCCESS = "Successfully created user - ";
    ...
    String ORDER_SUCCESS = "Order successfully submitted for user: ";

    String CART_IS_EMPTY = "Cannot submit order because the users cart is empty";
    String ADD_TO_CART_SUCCESS = "Successfully added to cart for user: ";
